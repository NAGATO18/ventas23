...
<head>
  ...
  <style>
    body {
      ...
      margin: 0;
      padding: 0;
      background-image: url(https://colima.decisiondeempresario.com/wp-content/uploads/2021/03/Herramientas.jpg);
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow">
    <div class="container-fluid">
      <a class="navbar-brand fw-bold" href="">WEB-Minimarket</a>
  ...
  <div class="container-fluid fondo-bienvenida">
    <h1 class="display-5 fw-semibold">Bienvenido al Panel de usuario</h1>
    <p class="lead">Usa la barra de navegación para registrar ventas o cerrar sesión.</p>
  </div>
